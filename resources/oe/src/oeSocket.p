...
lRC = hServer:ENABLE-CONNECTIONS('-S ' + cPort) NO-ERROR.
IF lRC = FALSE OR ERROR-STATUS:GET-MESSAGE(1) <> '' THEN
    DO:
        MESSAGE "SERVER FAILED WITH PORT:" cPort ". MESSAGE: " ERROR-STATUS:GET-MESSAGE(1).
        RETURN.
    END.

MESSAGE "SERVER STARTED AT " + cPort.
